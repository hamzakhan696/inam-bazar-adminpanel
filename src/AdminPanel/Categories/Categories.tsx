import { Group, Box, Button, Paper, Table, Avatar} from "@mantine/core";
            ...
            <Table verticalSpacing="sm" style={{ textAlign: 'left' }}>
              ...
              <tbody>
                <tr style={{ backgroundColor: 'white', marginBottom: '8px', display: 'table-row' }}>
                  ...
                  <td style={{ padding: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}><Avatar src="/path-to-avatar.jpg" radius="lg" size="lg" />Women</td>
                  <td style={{ padding: '12px' }}>15</td>
                  <td style={{ padding: '12px' }}>T-shirt</td>
                </tr>
                <tr style={{ backgroundColor: 'white', marginBottom: '8px', display: 'table-row' }}>
                  <td style={{ padding: '12px' }}><input type="checkbox" style={{ width: '20px', height: '20px' }} /></td>
                  <td style={{ padding: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}><Avatar src="/path-to-avatar.jpg" radius="lg" size="lg" />Men</td>
                  <td style={{ padding: '12px' }}>15</td>
                  <td style={{ padding: '12px' }}>T-shirt</td>
                </tr>
                <tr style={{ backgroundColor: 'white', marginBottom: '8px', display: 'table-row' }}>
                  <td style={{ padding: '12px' }}><input type="checkbox" style={{ width: '20px', height: '20px' }} /></td>
                  <td style={{ padding: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}><Avatar src="/path-to-avatar.jpg" radius="lg" size="lg" />Kids</td>
                  <td style={{ padding: '12px' }}>15</td>
                  <td style={{ padding: '12px' }}>T-shirt</td>
                </tr>
              </tbody>
